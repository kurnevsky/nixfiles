{ stdenv, lib, fetchFromGitea, qmake, qttools, qtbase, qtserialport, qtconnectivity
, qtcharts, qttranslations, wrapQtAppsHook }:
...
stdenv.mkDerivation rec {
  ...
  # *.so plugins are being automatically which breaks them
  dontWrapQtApps = true;
